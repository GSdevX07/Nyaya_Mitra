      ...
      >
        <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/[0.02]">
          <div className="flex items-center gap-2">
            ...
            {unreadCount > 0 && (
              <span className="text-[10px] bg-destructive/20 text-destructive border border-destructive/30 px-1.5 py-0.5 rounded-full font-mono font-bold">
                {unreadCount} unread
              </span>
            )}
          </div>
          <div className="flex items-center gap-2">
            {unreadCount > 0 && (
              <button
                ...
                className="text-xs text-accent hover:text-white transition-colors px-2 py-1 rounded hover:bg-white/5 font-medium"
              >
                Mark all read
              </button>
            )}
              ...
              <div
                ...
                className={`p-3.5 rounded-xl border transition-all cursor-pointer flex items-start gap-3 ${
                  item.read
                    ...
                    : "bg-white/[0.04] border-accent/20 hover:border-accent/40 shadow-sm"
                }`}
              >
