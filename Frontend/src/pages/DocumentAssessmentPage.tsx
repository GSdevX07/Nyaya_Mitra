      ...
      <div className="p-5 rounded-xl bg-[#0F141C] border border-white/10 shadow-xl space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-7 gap-2 relative">
          ...
          >
            ...
            <div className="text-xs font-bold">2. Scanned Check</div>
            <div className="text-[10px] text-amber-400 font-semibold mt-0.5">
              {result?.is_scanned_handwritten ? "YES (98% Conf)" : "Checking..."}
            </div>
          </div>

          {/* Node 3: Handwriting OCR (TrOCR) */}
          <div
          ...
          >
            ...
            <div className="text-xs font-bold">3. TrOCR Engine</div>
            <div className="text-[10px] text-muted-foreground mt-0.5 truncate">HuggingFace TrOCR</div>
          </div>

          {/* Node 4: Extracted Text */}
          <div
            className={`p-3 rounded-xl border text-center transition-all ${
              activeStep >= 4
                ? "bg-purple-500/10 border-purple-500/40 text-purple-300 shadow-md shadow-purple-500/10"
                : "bg-white/[0.02] border-white/10 text-muted-foreground"
            }`}
          >
            ...
            <div className="text-xs font-bold">4. Extracted Text</div>
            <div className="text-[10px] text-muted-foreground mt-0.5">Raw Text Payload</div>
          </div>

          {/* Node 5: IBM Data Prep Kit */}
          <div
            className={`p-3 rounded-xl border text-center transition-all ${
              activeStep >= 5
          ...
          >
            ...
            <div className="text-xs font-bold">5. IBM Data Prep</div>
            <div className="text-[10px] text-emerald-400 font-semibold mt-0.5">Clean & Structure</div>
          </div>
          ...
          >
            ...
            <div className="text-xs font-bold">6. RAG Layer</div>
            <div className="text-[10px] text-muted-foreground mt-0.5">BNSS 479 & Precedents</div>
          </div>

          {/* Node 7: IBM Granite Assessment */}
          <div
            className={`p-3 rounded-xl border text-center transition-all ${
              activeStep >= 6
                ? "bg-accent/20 border-accent text-accent shadow-lg shadow-accent/20 ring-1 ring-accent/50"
                : "bg-white/[0.02] border-white/10 text-muted-foreground"
            }`}
          >
            ...
            <div className="text-xs font-bold">7. IBM Granite</div>
            <div className="text-[10px] text-accent font-semibold mt-0.5">Preliminary Report</div>
          </div>
        </div>
      </div>
