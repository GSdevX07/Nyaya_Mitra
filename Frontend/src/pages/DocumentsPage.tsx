                  ...
                  <tr key={d.id} className="hover:bg-card shadow-sm transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      {!d.is_present && (
                        <button
                          onClick={() => {
                            openModal(d.case_id, d.document_type.toLowerCase().replace(/ /g, "_"));
                          }}
          ...
          >
            ...
            <div className="px-7 py-5 border-b border-border flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-primary">Upload Document</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    {selectedFile ? (
                      <>
                        ...
                        <div>
                          <p className="text-sm text-primary font-medium truncate max-w-[160px]">
                            {selectedFile.name}
                          </p>
                          <p className="text-xs text-muted-foreground mt-0.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={7}
                    className="w-full px-3 py-3 bg-secondary/50 border border-border rounded-2xl text-primary text-sm focus:outline-none focus:border-accent/60 transition-colors resize-none placeholder:text-muted-foreground/50 leading-relaxed"
                  />
                ...
                <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {uploadResult.file_name && uploadResult.file_name !== "manual_entry.txt" && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-secondary/50 text-primary/70 border border-border">
                  ...
                  {uploadResult.extracted_text && (
                    <div className="space-y-1.5">
                      ...
                      <div className="bg-background rounded-xl p-3 max-h-28 overflow-y-auto border border-white/5">
                        <p className="text-xs text-primary/80 whitespace-pre-wrap leading-relaxed font-mono">
